  ...
  return (
    <div className="p-4 max-w-4xl mx-auto text-sm select-none" style={{ WebkitTapHighlightColor: 'transparent' }}>
      ...
      <div className="text-xs text-gray-500 mb-1">Shidduch Organizer • v2.0 (Lite)</div>
            ...
            {/* Folder Tabs (full folder look) */}
<div role="tablist" aria-label="Sections" className="mb-4">
  <div className="relative">
    {/* baseline under tabs */}
    <div className="absolute inset-x-0 bottom-0 h-px bg-gray-200 z-0" />
    <div className="flex items-end gap-2">
      <button
        role="tab"
        aria-selected={tab==='prospects'}
        className={`px-3 py-2 rounded-t-2xl border transition-all
          ${tab==='prospects'
            ? 'bg-white text-blue-700 border-blue-600 border-b-transparent -mb-px z-10 shadow'
